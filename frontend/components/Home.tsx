  ...
  return (
    ...
    <div className="flex justify-center items-center h-screen max-w-[50vw] mx-auto col-span-2">
      <div className="flex flex-col items-center">
        ...
        <button onClick={handleUpload} disabled={loading || !file} className={`rounded-full  duration-200 mt-4  font-bold py-2 px-4  disabled:opacity-50 ${loading ? "bg-gray-400" : "bg-black"}`}>
